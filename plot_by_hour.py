...
for start_hour, end_hour in zip(range(0,23), range(1,24)):
    ...
    title = f'{parameter} Mean at {start_hour}-{end_hour} hour (October/November 2018)'
    path = f'plots/pm10_mean_by_hour/{parameter}_by_hour_{start_hour}_{end_hour}_mean.png'
